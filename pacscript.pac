...
/*
** automatic proxy configuration for 10.97.196.162 from proxyconf.my-it-solutions.net
*/
...
function FindProxyForURL(url, host) {
 ...
 if ( shExpMatch(host, "pct.cio.siemens.de") ) { return "DIRECT"; }
 ...
 if ( shExpMatch(host,  "siemens-it-solutions.de") ) { return "DIRECT"; }
 if ( shExpMatch(host,  "*.salesservice.myatos.net") ) { return "DIRECT"; }
 if ( shExpMatch(host,  "salesservice.myatos.net") ) { return "DIRECT"; }
